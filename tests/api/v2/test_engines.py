...
async def test_catalog_returns_all_seven_engines(async_client: AsyncClient) -> None:
    """GET /api/v2/engines/catalog returns all seven engine slugs (static fallback)."""
