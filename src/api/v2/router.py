...
Mounts the six engine sub-routers under ``/api/v2/engines/``. This router
itself is mounted at ``/api/v2`` by :mod:`src.main`.
"""

from fastapi import APIRouter

from src.api.v2.engines import backtest, catalog, execution, market_data, portfolio, signals
